...
//     const container = this.host.shadowRoot.querySelector(
...
//       const offsetX =
//         dims.left + container.ownerDocument.defaultView.pageXOffset;
//       const offsetY =
//         dims.top + container.ownerDocument.defaultView.pageYOffset;
//       const x =
...
//     if (target.closest('a-color-picker') !== this.host) {
//       this.dropdown.hide();
//     }
//   }
...
//             hsl.l
//           )}%, ${Number(hsl.a.toFixed(2).toString())})`
//         ),
//       },
//       rgb: {
//         r: rgb.r,
...
//             rgb.b
//           )}, ${Number(rgb.a.toFixed(2).toString())})`
//         ),
//       },
...
//     // Update the value
//     if (this.format === 'hsl') {
//       this.textInputValue = this.opacity
...
//               role="slider"
//               aria-label="HSL"
//               aria-valuetext={`hsl(${Math.round(this.hue)}, ${Math.round(
//                 this.saturation
...
//               style={{
//                 color: `hsla(${this.hue}deg, ${this.saturation}%, ${
//                   this.lightness
//                 }%, ${this.alpha / 100})`,
//               }}
//             />
...
//             >
//               <a-icon name={this.showCopyCheckmark ? 'check2' : 'clipboard'} />
//             </a-button>
//           </div>
